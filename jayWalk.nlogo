...
to setup-traffic-lights
  set traffic-light-state "red"
  ask patches with [pxcor = 28 and pycor = 8] [
    set pcolor red
  ]
  ask patches with [pxcor = 28 and pycor = 9] [
    set pcolor red
  ]
  ask patches with [pxcor = 29 and pycor = 8] [
    set pcolor red
  ]
  ask patches with [pxcor = 29 and pycor = 9] [
    set pcolor red
  ]
end
...
to go
  ...
  while [count turtles < max-turtles] [
    create-turtles 1 [
      let pos one-of [[-48 15] [-48 12] [48 -14] [48 -11]]
      setxy item 0 pos item 1 pos
      set stopped false
